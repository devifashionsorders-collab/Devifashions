...
// Behavior:
// - If S3 is configured (S3_BUCKET + region), multer memory storage -> upload to S3 -> store absolute S3 URLs in product.images
// - Else fallback to local disk storage (public/uploads) and store relative /uploads/<file> paths
if (s3Client) {
...
// Saved product.images will be [imageUrl] if provided
...
app.get("/product/:id", (req, res) => {
  ...
  // images array (may contain S3 URLs or local paths)
